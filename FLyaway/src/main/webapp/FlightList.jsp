...
<body >
<div align="center">
<h2>Fly Away Booking Portal</h2><hr>
</div>
...
<div style="border:3px solid black;width:22%;height:20%;background-color:lightblue;border-radius:15px;padding:20px" 
align="center">
<p style="font-size:20px">The list of flights available are</p>
<table border="2">
<tr>
<th>Name</th>
<th>Time</th>
